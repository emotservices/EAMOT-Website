...
<body>
            ...
            <div class="container-fluid">
               <div class="row align-items-center">
                  ...
                  <div class="col-xxl-6 col-xl-7 d-none d-xl-block">
                     <div class="main-menu main-manu-before">
                        <nav id="mobile-menu">
                           <ul>
                              ...
                              <li class="has-dropdown has-megamenu">
                                 <a href="service-3.html#">Pages</a>
                                 <ul class="mega-menu">
                                    <li>
                                       <a class="" href="service-3.html#">Layout 1</a>
                                       <ul>
                                    ...
                                    <li>
                                       <a href="service-3.html#">Layout 2</a>
                                       <ul>
                                    ...
                                    <li>
                                       <a href="service-3.html#">Layout 3</a>
                                       <ul>
                                    ...
                                    <li>
                                       <a href="service-3.html#">Layout 4</a>
                                       <ul>
                                    ...
                                    <li>
                                       <a href="service-3.html#">Layout 5</a>
                                       <ul>
                                    ...
                                    <li>
                                       <a href="service-3.html#">Layout 6</a>
                                       <ul>
                  ...
                  <div class="col-xxl-4 col-xl-3 d-xl-block col-md-6 col-6">
                     <div class="tp-header__1-right d-flex justify-content-end align-items-center">
                        <div class="header-mail-info mr-40 ">
                           <a href="mailto:info@gencio.com"><i class="fas fa-envelope-open"></i>info@gencio.com</a>
                        </div>
                        <a href="service-3.html#" class="tp-btn d-none d-xl-block">Get Quote<span><i
      ...
      <div class="tp-offcanvas white-bg">
         ...
         <div class="tp-offcanvas__top tp-border-bottom pb-30 mb-30">
            ...
            <div class="tp-offcanvas__logo mb-50">
               <a href="index.php"><img src="assets/img/logo/black-logo.png" alt="sticky-logo"></a>
            </div>
            <p> We bring your ideas to better product. Base in NYC</p>
            <div class="tp-offcanvas__social">
               <span> <a href="service-3.html#"><i class="fab fa-facebook-f"></i></a></span>
               <span> <a href="service-3.html#"><i class="fab fa-twitter"></i></a></span>
               <span> <a href="service-3.html#"><i class="fab fa-behance"></i></a></span>
               <span> <a href="service-3.html#"><i class="fab fa-youtube"></i></a></span>
            </div>
         </div>
         <div class="tp-offcanvas__widget mb-40 d-none d-xl-block">
            ...
            <div class="tp-offcanvas-cta d-flex align-items-center pb-20  mb-30">
               ...
               <span>
                   <span class="d-block mb-0">1300 Don City, NYC</span>
                  <b><a href="callto:0002229090"> Call Us: 000-222-9090 </a></b>
               </span>
            </div>
         </div>
         ...
         <div class="tp-offcanvas__bottom mt-80 d-none d-lg-block">
            ...
            <div class="tp-offcanvas-btn-wrapper">
               <a href="service-3.html#" class="tp-common-btn">get in touch
                  <span>
   ...
   <main>
               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <div class="breadcrumb__list mb-10">
                        ...
                        <span class="tp-bc-acive-menu">Services v3</span>
                     </div>
      ...
      <div class="tp-service-page pt-120 pb-90">
         <div class="container">
            <div class="row">
               <div class="col-lg-4 wow">
                  <div class="sv-page-item white-bg mb-30 wow tpfadeUp" data-wow-delay=".3s">
                     <div class="sv-page-item__img p-relative mb-30">
                        <div class="w-img">
                           <img src="assets/img/services/sv-page-item-1.jpg" alt="">
                        </div>
                        <div class="sv-page-item__icon">
                           <span><i class="flaticon-computer"></i></span>
                        </div>
                     </div>
                     <h3 class="sv-page-item__title text-center pb-30"><a href="service-3.html#">IT Consultancy</a></h3>
                  </div>
               </div>
               <div class="col-lg-4" >
                  <div class="sv-page-item white-bg mb-30 wow tpfadeUp" data-wow-delay=".4s">
                     <div class="sv-page-item__img p-relative mb-30">
                        <div class="w-img">
                           <img src="assets/img/services/sv-page-item-2.jpg" alt="">
                        </div>
                        <div class="sv-page-item__icon">
                           <span><i class="flaticon-server"></i></span>
                        </div>
                     </div>
                     <h3 class="sv-page-item__title text-center pb-30"><a href="service-3.html#">Product Design</a></h3>
                  </div>
               </div>
               <div class="col-lg-4" >
                  <div class="sv-page-item white-bg mb-30 wow tpfadeUp" data-wow-delay=".4s">
                     <div class="sv-page-item__img p-relative mb-30">
                        <div class="w-img">
                           <img src="assets/img/services/sv-page-item-3.jpg" alt="">
                        </div>
                        <div class="sv-page-item__icon">
                           <span><i class="flaticon-hacker"></i></span>
                        </div>
                     </div>
                     <h3 class="sv-page-item__title text-center pb-30"><a href="service-3.html#">Cyber Security</a></h3>
                  </div>
               </div>
               <div class="col-lg-4" >
                  <div class="sv-page-item white-bg mb-30 wow tpfadeUp" data-wow-delay=".4s">
                     <div class="sv-page-item__img p-relative mb-30">
                        <div class="w-img">
                           <img src="assets/img/services/sv-page-item-4.jpg" alt="">
                        </div>
                        <div class="sv-page-item__icon">
                           <span><i class="flaticon-design"></i></span>
                        </div>
                     </div>
                     <h3 class="sv-page-item__title text-center pb-30"><a href="service-3.html#">UI & UX Designer</a></h3>
                  </div>
               </div>
               <div class="col-lg-4" >
                  <div class="sv-page-item white-bg mb-30 wow tpfadeUp" data-wow-delay=".4s">
                     <div class="sv-page-item__img p-relative mb-30">
                        <div class="w-img">
                           <img src="assets/img/services/sv-page-item-5.jpg" alt="">
                        </div>
                        <div class="sv-page-item__icon">
                           <span><i class="flaticon-world-wide-web"></i></span>
                        </div>
                     </div>
                     <h3 class="sv-page-item__title text-center pb-30"><a href="service-3.html#">Web Development</a></h3>
                  </div>
               </div>
               <div class="col-lg-4" >
                  <div class="sv-page-item white-bg mb-30 wow tpfadeUp" data-wow-delay=".4s">
                     <div class="sv-page-item__img p-relative mb-30">
                        <div class="w-img">
                           <img src="assets/img/services/sv-page-item-6.jpg" alt="">
                        </div>
                        <div class="sv-page-item__icon">
                           <span><i class="flaticon-bubble-chat"></i></span>
                        </div>
                     </div>
                     <h3 class="sv-page-item__title text-center pb-30"><a href="service-3.html#">24/7 Online Support</a></h3>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="tp-bs-cta-area pt-105 pb-120 black-bg p-relative">
         <div class="container">
            <div class="row">
               <div class="col-12">
                  <div class="bs-cta-section text-center">
                     <span class="bs-cta-section__subtitle wow tpfadeUp">
                     ...
                     <div class="cd-intro">
                        <h3
                           ...
                           <span class="cd-words-wrapper bs-cta-wrapper ca-cta-wrapper">
                              <b class="is-hidden"> Gencio</b>
                              <b class="is-hidden">Branding</b>
                              <b class="is-visible">Markting</b>
                           </span>
            ...
            <div class="row">
               <div class="bs-cta-btns text-center">
                  <a href="service-3.html#" class="tp-btn mr-30 wow tpfadeRight">Schedule a meeting
                     <span>
                        <i class="fal fa-long-arrow-right"></i>
                        <i class="fal fa-long-arrow-right"></i>
                     </span>
                  </a>
                  <a href="service-3.html#" class="tp-white-btn wow tpfadeLeft">
                     <span class="mr-10">
         ...
         <div class="ca-cta-avata">
            <img src="assets/img/cta/ca-avata.png" alt="">
         </div>
         <div class="ca-cta-avata-2 ">
            <img src="assets/img/cta/cta-avata-2.png" alt="">
         </div>
      </div>
               ...
               <div class="row align-items-center">
                  <div class="col-6">
                     <div class="bs-footer__top-logo">
                        <a href="index.php"><img src="assets/img/logo/black-logo.png" alt=""></a>
                     </div>
                  </div>
            ...
            <div class="bs-footer__main pb-10 pt-80 tp-border-bottom">
               <div class="row justify-content-center">
                  <div class="col-xl-3 col-md-6">
                     ...
                     <div class="tp-footer-cta d-flex align-items-center">
                  ...
                  <div class="col-xl-3 col-md-6">
                     <div class="tp-footer__widget mb-40">
                        ...
                        <ul id="company">
                           ...
                           <li><a href="faq.html">Affiliates</a></li>
                          <li><a href="job.html">Careers</a></li>
                           <li><a href="privacy-policy.html">Legal & Privacy</a></li>
                           <li><a href="team.html">Our Team</a></li>
                           <li><a href="privacy-policy.html">Refund Policy</a></li>
                            <li><a href="privacy-policy.html">Refund Policy</a></li>
                           <li><a href="contact.html">Get In Touch</a></li>
                           <li><a href="service-3.html#">other</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-2 col-md-6">
                     <div class="tp-footer__widget mb-40">
                        ...
                        <ul>
                           <li><a href="service-3.html#">Business Consultancy</a></li>
                           <li><a href="service-3.html#">Web Development</a></li>
                           <li><a href="service-3.html#">UI & UX Design</a></li>
                           <li><a href="privacy-policy.html">Legal & Privacy</a></li>
                           <li><a href="service-3.html#">Engine Optimization</a></li>
                           <li><a href="service-3.html#">Digital marketing</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-4 col-md-6">
                     <div class="tp-footer__widget bs-pl-60 mb-40">
                        ...
                        <div class="tp-footer-from p-relative">
                           <form>
                        ...
                        <p class="tp-form-note p-0 mt-5 mb-30"> <span>**</span>We are not going to save your data </p>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row align-items-center">
                  <div class="col-md-8 col-12">
                     <div class="tp-copyrigh-text text-center text-md-start">
                        <span>Copyright & Design By <a href="service-3.html#">@Theme Pure</a> - 2022</span>
                     </div>
                  </div>
